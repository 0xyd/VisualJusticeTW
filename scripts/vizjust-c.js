...
'合計發生件數':'#70C1B3','重大竊盜發生件數':'#F25F5C','普通竊盜發生件數':'#FFE066','汽車竊盜發生件數':'#247BA0','機車竊盜發生件數':'#2C5B26','重大竊盜破獲件數':'#9BC53D','重大竊盜尚未破獲件數':'#E55934','重大竊盜嫌疑犯人數':'#F24B48','重大竊盜破獲率':'#EDAFB8','普通竊盜破獲件數':'#5BC0EB','普通竊盜尚未破獲件數':'#FA7921','普通竊盜嫌疑犯人數':'#DB8A62','普通竊盜破獲率':'#E56322','汽機車竊盜案件':'#00A8E8','汽車竊盜破獲件數':'#EF233C','汽車竊盜尚未破獲件數':'#EDF2F4','汽車竊盜破獲率':'#0CCA4A','汽車竊盜嫌疑犯人數':'#F24B48','機車竊盜案件數':'#A04D20','機車竊盜破獲件數':'#35C3D6','機車竊盜尚未破獲件數':'#FF1654','機車竊盜嫌疑犯人數':'#FFD000','機車竊盜破獲率':'#C1292E','非汽機車竊盜發生件數':'#AD0625', // For 殺人罪 (Prosecution)
...
.style('width',function(){return nw+'px';});}else if(tipType==='DOT-TIP')this.dotTip.node().offsetHeight;return this;};tipClass.prototype.remove=function(){d3.select('#DOT-TIP').remove();d3.select('#BAR-TIP').remove();d3.select('#CIRCLE-TIP').remove();return this;}; /* Additional Functions */ /* 
...
},{key:'_labelCircles',value:function _labelCircles(circles,texts){ // Sort the circles according to x positions
