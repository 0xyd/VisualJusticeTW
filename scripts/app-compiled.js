...
pageHasNotFinished:function pageHasNotFinished(){window.alert('即將推出，敬請期待。');},getInitialState:function getInitialState(){return {nav:[ /*<RR.Link to='/about_us'>
				...
				</RR.Link>, */React.createElement('img',{src:'./src/aboutus.png',onClick:this.pageHasNotFinished}),React.createElement('img',{src:'./src/see.png',onClick:this.pageHasNotFinished}),React.createElement('img',{src:'./src/issue.png',onClick:this.pageHasNotFinished}),React.createElement('img',{src:'./src/work.png',onClick:this.pageHasNotFinished}),React.createElement('div',{className:'social-group'},React.createElement('iframe',{id:'githubStar',className:'social-btn',src:'https://ghbtns.com/github-btn.html?user=twbs&repo=bootstrap&type=star&count=true',frameborder:'0',scrolling:'0',width:'170px',height:'20px'}))]};},render:function render(){var listItems=[],l=this.state.nav.length;for(var i=0;i<l;i++){if(i===l-1){listItems.push(React.createElement(IndexNavListSocialItem,{key:i,elements:this.state.nav[i]}));}else {listItems.push(React.createElement(IndexNavListItem,{key:i,link:this.state.nav[i]}));}}return React.createElement('nav',{id:'NAV',className:'b12-col-md-12 b15-row-md-9'},React.createElement('ul',{className:'b12-col-md-12 b15-row-md-15'},listItems));}});var IndexNavListItem=React.createClass({displayName:'IndexNavListItem',getInitialState:function getInitialState(){return {isHovered:false};},mouseEnterItem:function mouseEnterItem(){this.setState({isHovered:true});},mouseLeaveItem:function mouseLeaveItem(){this.setState({isHovered:false});},render:function render(){return React.createElement('li',{onMouseEnter:this.mouseEnterItem,onMouseLeave:this.mouseLeaveItem,className:'nav-option b12-col-md-12 b12-row-md-2'},React.createElement('span',{className:'ver-helper'}),React.createElement('div',{className:this.state.isHovered?'nav-option-hovermarker active':'nav-option-hovermarker'}),this.props.link);}}); // working-spot
