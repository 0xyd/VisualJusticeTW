...
class Spider():
    ...
    def __init__(self):
        ...
        # self.spider = webdriver.Chrome(
        #     executable_path=r'/home/david/git/test-python/chromedriver_linux64/chromedriver',
        #     chrome_options=chrome_options)
        # self.spider.set_window_position(1280, 800)
        self.spider.get(
            'http://www.rjsd.moj.gov.tw/RJSDWEB/inquiry/InquireAdvance.aspx')
        sleep(3)
    ...
    def select_time_unit(self, opt_name='year'):
        ...
        options = select_bar.find_elements_by_css_selector(
            '#ctl00_cphMain_ddlQPeriod option')
    ...
    def select_time_range(self, start_year, end_year, start_month=1, end_month=12, opt_name='mon'):
        ...
        begin_year_selector = self.spider.find_element_by_id(
            'ctl00_cphMain_ddlQYearBegin')
        begin_years = begin_year_selector.find_elements_by_css_selector(
            'option')
        ...
        try:
            ...
            if begin_yr_index < 0:
                ...
                print('The begin latest year is 民國 %d' %
                      (93 + len(begin_years)))

        try:
            months = self.spider.find_elements_by_css_selector(
                '#ctl00_cphMain_ddlQDateBegin > option')
        ...
        end_year_selector = self.spider.find_element_by_id(
            'ctl00_cphMain_ddlQYearEnd')
        ...
        try:
            months = self.spider.find_elements_by_css_selector(
                '#ctl00_cphMain_ddlQDateEnd > option')
